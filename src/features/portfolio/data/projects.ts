...
- Tối ưu media và hiệu năng để hero và trang nội dung luôn nhanh trên mọi thiết bị.`,
  },
}

export const PROJECTS_VI: Project[] = PROJECTS_EN.map((project) => {
  const override = PROJECT_VI_OVERRIDES[project.id]
  if (!override) return project

  return {
    ...project,
    ...override,
    period: { ...project.period, ...override.period },
  }
})
