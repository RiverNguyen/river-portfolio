  ...
  return (
    <div className="screen-line-after flex border-x border-edge">
      <div className="shrink-0 border-r border-edge">
        <div className="mx-0.5 my-0.75 flex size-24 items-center justify-center rounded-full border border-edge/60 bg-background p-1.5 ring-1 ring-border ring-offset-2 ring-offset-background select-none sm:size-40 sm:p-2">
