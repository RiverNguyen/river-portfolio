...
Pixel-perfect không phải copy từng vị trí absolute. Nghĩa là site live cảm giác cùng một sản phẩm khi khách mở điện thoại cạnh preview Figma. Đó là tiêu chuẩn mình dùng trên case study [agency website](/projects/agency-website) và [corporate landing page](/projects/corporate-landing-page). Khi layout đã vững mà cần timeline, mình chuyển sang ghi chú [GSAP trong production](/blog/gsap-animations-in-production).

Làm token trước. Tái sử dụng sau. Polish cuối cùng.

Docs nên bookmark: [Tailwind CSS](https://tailwindcss.com/docs), [shadcn/ui](https://ui.shadcn.com/docs), và [Figma Dev Mode](https://help.figma.com/hc/en-us/articles/15023124644247-Guide-to-Dev-Mode).
