...
On a multilingual tour-booking platform, I improved PageSpeed by combining image optimization, code splitting, and deferring non-critical scripts. The site targeted international tourists on mobile networks — every 100ms matters.
