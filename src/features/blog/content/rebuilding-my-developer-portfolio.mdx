...
I'll keep writing here about frontend patterns I use in production — [WordPress + Next.js](/blog/wordpress-headless-cms-with-nextjs), [GSAP workflows](/blog/gsap-animations-in-production), [Docker without leaking secrets](/blog/shipping-nextjs-with-docker), and [Core Web Vitals](/blog/optimizing-nextjs-for-core-web-vitals) from real projects. The bilingual routing on this site is covered in [Building bilingual Next.js sites with next-intl](/blog/bilingual-nextjs-with-next-intl).

If you're building your own portfolio, start simple: one great [project case study](/projects) beats ten generic cards. Or [get in touch](/contact) if you want to talk through a rebuild.

Stack references for this rebuild: [Next.js App Router](https://nextjs.org/docs/app), [next-intl](https://next-intl.dev/docs), and [Tailwind CSS](https://tailwindcss.com/docs).
